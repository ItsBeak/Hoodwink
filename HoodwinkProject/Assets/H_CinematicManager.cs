    ...
    IEnumerator PlaySpyIntroCutscene(List<IntroCosmeticData> players)
    {
        ...
        else
        {
            ...
            if (players.Count == 2 || players.Count == 3)
            {
                ...
                firstSpyPlayerAgentName.text = H_GameManager.ColorWord(players[0].agentData.agentName, players[1].agentData.primaryColour);
            }
            ...
            if (players.Count == 3)
            {
                ...
                secondSpyPlayerAgentName.text = H_GameManager.ColorWord(players[0].agentData.agentName, players[2].agentData.primaryColour);
            }
        }
